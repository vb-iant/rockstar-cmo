...
![](https://open.buffer.com/wp-content/uploads/2019/05/Buffer-San-Diego-team-retreat-posterboard-1024x1536.jpg)

In [this splendid article,](https://open.buffer.com/product-marketing/)VP Marketing at Buffer, [Kevan Lee](https://twitter.com/kevanlee) shares a really detailed break down of the six things his team has learned as it has grown to 80 people, offering some great tips on how scale and manage a team as it grows. We particularly like this:
...
Still, on the start-up theme, we came across this on the [Soapboxly blog](https://soapboxly.com/), apparently authored by the team, but maybe it's the work of founder [Kameron Jenkins](https://twitter.com/Kammie_Jenkins). The article sets out to discuss the age-old challenge for product companies:
...
[[ READ MORE ]](https://soapboxly.com/outsource-marketing/product-vs-marketing-growth-startups/)

### Bridging the gaps

In "[How do CEOs define and value product marketing?](https://productmarketingalliance.com/how-do-ceos-define-and-value-product-marketing/)" on the [Product Marketing Alliance blog](https://productmarketingalliance.com/how-do-ceos-define-and-value-product-marketing/), Mark Shapiro makes this great point as he discusses the role of product marketing sitting between the product guys and marcoms:

***Buyers seek information, not products.***

We agree and his article lists five points that can help validate the role of product marketing to the CEO and build connections in the business. [[ READ MORE ]](https://productmarketingalliance.com/how-do-ceos-define-and-value-product-marketing/)
...
In [The Art of Audience-Driven Marketing: Stop Selling Products, Start Building Audiences](https://www.cmswire.com/digital-marketing/the-art-of-audience-driven-marketing-stop-selling-products-start-building-audiences/) by Lytics CTO and co-founder [Aaron Raddon](https://twitter.com/araddon) on CMSWire, Aaron suggests we shift this consumer research earlier into the process.
...
[[ READ MORE ]](https://www.cbinsights.com/research/corporate-innovation-product-fails/)