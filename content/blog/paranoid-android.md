...
Moving up one level of weirdness, Italian company Almax has created the [EyeSee mannequin](http://www.almax-italy.com/en-us/page/eyesee-mannequin-en), which tracks the age, sex and race of shoppers and helps tailor the service to suit them. Meanwhile Clear Channel has been experimenting to determine if adverts can be altered according to an onlooker’s mood. One outdoor campaign used facial recognition to personalize car ads – the hoarding’s camera scanning number plates to identify passing car marques. If it spotted a Mercedes, it would inform its driver of the wonders of the BMW X5.
...
*For more on Mark Stevenson, follow him on [Twitter](https://twitter.com/optimistontour?lang=en).*