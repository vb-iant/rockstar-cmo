...
There is actually a pre-step, which is to understand your [Ideal Customer Profile (ICP)](https://rockstarcmo.com/tune-in-to-your-icp-ideal-customer-profile/), as this will give you the context of organisational needs that will feed the needs of your personas.
...
Understanding why customers might choose inaction is key—whether it is due to perceived risks or a fear of making a mistake (that I've referred to as [FOFU, or Fear of Fucking Up](https://iantruscott.com/tuesday-2c-everybody-is-fofu-fighting/)). It's emotional.
...
As an aside, I learned a really simple model recently from Robert Rose on the podcast (also shared on [his Content Marketing Institute column](https://contentmarketinginstitute.com/articles/content-intent-improve-relationship-sales)); consider these three ways you can help: inspiration, implication, and initiation.
...
*Photo used above and in the promotion is by [Marten Newhall](https://unsplash.com/pt-br/@laughayette?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/photos/uAFjFsMS3YY?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)*