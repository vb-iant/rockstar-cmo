...
In my recent acronym littered blog post, [OKRs, KPIs, ROI … OMG](https://rockstarcmo.com/okrs-kpis-roi-omg/), I staked out how CMOs can use the goal setting process to make marketing relevant, accountable and measurable. I outlined five f’in fundamentals of setting OKRs.
...
*Photo by [Markus Spiske](https://unsplash.com/@markusspiske?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/images/sports/soccer?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)*