...
As I [wrote at Content Marketing Institute](https://contentmarketinginstitute.com/2020/04/job-loss-build-personal-brand/), I was laid off during the 2008 Financial Crisis. [Inspired by David Meerman Scott](https://www.davidmeermanscott.com/blog/2008/11/downsized-fired-here-are-the-new-rules-of-finding-a-job.html), I immediately launched a blog about a topic I was an expert in: virtual events.
...
If that’s not an option, set up a [Medium](https://medium.com/) account or publish an article on LinkedIn. Each site has a built-in audience. On LinkedIn, your post may be seen by a lot of your first degree connections.

The first few posts you publish can serve as valuable writing samples. Take your best-performing samples and use them in pitches for guests posts on other sites. As a marketer, getting published on HubSpot’s Marketing blog would be a big win. Check out their [guest post guidelines](https://blog.hubspot.com/marketing/marketing-guest-blogging-guidelines) and follow them to a tee.

Also, read this [step-by-step guide on guest blogging](https://contentmarketinginstitute.com/2019/10/guide-guest-blogging/) by Content Marketing Institute’s Ann Gynn and consider this [systematic approach from Maureen Jann](https://contentmarketinginstitute.com/2019/07/choose-topic-guest-blog/). If you’re a content marketer, aspire to get published one day at Content Marketing Institute.
...
Second: it’s a crowded space right now, so figure out your unique angle or format. For a good example, look no further than this site, where Ian Truscott hosts the [Rockstar CMO FM podcast](https://rockstarcmo.com/category/podcast/). I have no doubt that the podcast has enhanced the Rockstar CMO brand, as well as Ian’s personal brand.
...
Robert Rose wrote a fantastic post that breaks down his [end-to-end podcasting production process](https://contentmarketinginstitute.com/2020/04/process-publish-podcast-tools/). Robert has produced 235 episodes of *This Old Marketing* (with Joe Pulizzi) and 66 episodes of *The Weekly Wrap* (from Content Marketing Institute).
